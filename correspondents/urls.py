...
from .views import list_corrs, add_corrs, detail_corrs, delete_corrs, update_corrs, case_corrs, case_add_corrs,edit_cors
...
urlpatterns = [
    ...
    path('correspondents/<int:pk>/edit', edit_cors, name="edit"),
