...
from .views import (document_detail, document_list, record_detail, record_list, update_document,
                    ...
                    document_delete_view, request_doc, record_update, record_delete, approve_request, document_archive_list,
                    record_archive_list, upload_files, delete_file,
...
urlpatterns = [
    ...
    path("documents/approved-requests",
         ApprovedList.as_view(), name="approved-list"),
    path("doccuments/requests/<int:pk>/return-document",
         return_document, name="return-doc"),
