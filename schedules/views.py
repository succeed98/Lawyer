...
def schedule_room(request):
    ...
    if request.method == "POST":
        ...
        add_log(request.user.pk,schedule,"added a schedule")
        print('success')
...
def delete_booking(request, pk):
    ...
    if sch:
        add_deletion(request.user.pk,sch,"deleted booking")
        sch.delete()
...
def list_sessions(request):
    ...
    print("pink {}". format(pink_))
    print("yellow {}". format(yellow_))
...
def add_session(request):
    if request.method == "POST":
        ...
        add_log(request.user.pk,schedule,"added bookin , your session starts")
...
def delete_session(request, pk):
    ...
    if sch:
        sch.delete()
        log_deletion(request.user.pk,sch,"deleted case files")
